...
int main()
{
  ...
  assert((
    std::is_same<
      decltype(get<0>(static_cast<const type2&>(t3))),
      const int&
    >::value
  ));
  ...
  assert((
    std::is_same<
      decltype(get<1>(static_cast<const type2&>(t3))),
      const float&
    >::value
  ));
  ...
  assert(get<0>(get<0>(t7)) == 1);
  assert(get<1>(get<0>(t7)) == 2);
  assert(get<2>(get<0>(t7)) == 3);

  assert(get<0>(get<1>(t7)) == 4);
  assert(get<1>(get<1>(t7)) == 5);
  assert(get<2>(get<1>(t7)) == 6);
...

  {
    ...
    assert(get<int>(t) == 1);
    assert(get<double>(t) == 13.);
    assert(get<std::string>(t) == "hello");
  }
